...
# ===== Encoded Config =====
ENCODED_OWNER_IDS = "Wzc4MDg2MDMwNDQsIDc0ODI4ODc2NTRd"  # Base64 of [7808603044, 7482887654]
ENCODED_BOT_TOKEN = "ODQ1MzQ1NzEwOTo6QUFHM1Jjd09UQ0N5ZVQ1MXhpbHF4cS00Q2UxeFBoMWV1Zmhv"  # Base64 of token
ENCODED_OWNER_USERNAMES = "WyJQcm9ibGVtX1plbmtpIiwicWNfYmFiYSJd"  # Base64 of ["Problem_Zenki","qc_baba"]

# ===== Decode =====
OWNER_IDS = json.loads(base64.b64decode(ENCODED_OWNER_IDS).decode())
BOT_TOKEN = base64.b64decode(ENCODED_BOT_TOKEN).decode()
OWNER_USERNAMES = json.loads(base64.b64decode(ENCODED_OWNER_USERNAMES).decode())

# ===== Runtime integrity check =====
def check_integrity():
    try:
        assert OWNER_IDS == [7808603044, 7482887654]
        assert OWNER_USERNAMES == ["Problem_Zenki", "qc_baba"]
        assert BOT_TOKEN == "8453457109:AAG3RcwOTDCyeT51xiaxq-4Ce1X9dh1ufho"
    except AssertionError:
        print("⚠️ Owner ID / Username / Token has been tampered! Exiting.")
        sys.exit(1)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    button1 = InlineKeyboardButton(
        text="Permission တောင်းရန် 1",
        url="tg://user?id=7482887654"  # ပထမ channel link
    )
    button2 = InlineKeyboardButton(
        text="Permission တောင်းရန် 2",
        url="https://t.me/rh_rhyam_12"  # ဒုတိယ channel link
    )
